...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2017 at 10:12 AM
...
INSERT INTO `client` (`client_id`, `lastname`, `firstname`, `address`, `gender`, `username`, `password`, `email`, `logstat`, `image`, `contact`) VALUES
(1, 'Makiling', 'Maria', '123 Jupiter, Solar System', 'f', 'client1', '1234', 'mama@gmail.com', 'out', NULL, 0);
...
INSERT INTO `request` (`request_id`, `sp_id`, `client_id`, `status`, `date`, `time`, `sched_id`) VALUES
(1, 1, 1, 'pending', '2017-05-06', '13:00:00', 1),
(2, 1, 1, 'accepted', '2017-05-05', '14:00:00', 1),
(3, 1, 1, 'pending', '2017-05-07', '15:00:00', 1);
...
(1, 1, '11:00 pm-12:00 pm', 'Thursday', 'available', 1);
...
(1, 'approve', 'Dela Cruz', 'Juan', 'm', 'sp1', '1234', '1234@gmail.com', NULL, '#123 Magsaysay St., Baguio City', 'logout');
