...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2017 at 02:49 PM
...
INSERT INTO `appointments` (`app_id`, `date`, `time`, `status`, `request_id`, `transaction_id`) VALUES
(1, '2017-05-13', '23:00:00', 'ongoing', 2, 1),
(2, '2017-05-24', '12:00:00', 'ongoing', 6, 2),
(3, '2017-05-14', '13:00:00', 'ongoing', 3, 3),
(4, '2017-05-14', '23:00:00', 'ongoing', 19, 11),
(5, '2017-05-14', '23:00:00', 'ongoing', 20, 12),
(6, '2017-05-18', '23:00:00', 'ongoing', 20, 12),
(7, '2017-05-14', '23:00:00', 'ongoing', 21, 13),
(8, '2017-05-18', '23:00:00', 'ongoing', 21, 13),
(9, '2017-05-25', '23:00:00', 'ongoing', 21, 13),
(10, '2017-05-18', '23:00:00', 'ongoing', 22, 14),
(11, '2017-05-25', '23:00:00', 'ongoing', 22, 14),
(12, '2017-06-01', '23:00:00', 'ongoing', 22, 14);
...
INSERT INTO `client` (`client_id`, `lastname`, `firstname`, `address`, `gender`, `username`, `password`, `email`, `image`, `contact`, `reg_status`) VALUES
(1, 'Makiling', 'Maria', '123 Jupiter, Solar System', 'f', 'client1', '1234', 'mama@gmail.com', NULL, 0, 'pending'),
(2, 'Alba', 'Pia', '69 Kasuluksulukan St., Baguio City', 'f', 'client2', '1234', 'aba@gmail.com', NULL, 0, 'pending'),
(3, 'Ibarra', 'Crisostomo', 'Bonifacio St., Baguio City', 'm', 'client3', '1234', 'bolang_kristal@gmail.com', NULL, 0, 'pending'),
(4, 'testing', 'testing', 'testing', 'm', 'testing', 'dc724af18fbdd4e59189f5fe768a5f8311527050', 'testin@yahoo.com', NULL, 3453453, 'approve');
...
('0w7w33h09kzr1us5hyetr7a916h6hmsa', 'ZjM5MjZmNGQwZTI1MDExODA0MTUwMzc4MjUxOTdmNDBhZTFlNGQ2ODp7InVzZXJuYW1lIjoic3AxIn0=', '2017-05-29 05:34:24.318507'),
('6jebwyf6g72fd19zjq52bd81joqni5oz', 'ZjM5MjZmNGQwZTI1MDExODA0MTUwMzc4MjUxOTdmNDBhZTFlNGQ2ODp7InVzZXJuYW1lIjoic3AxIn0=', '2017-05-29 13:11:17.200601');
...
INSERT INTO `message` (`msg_id`, `sp_id`, `client_id`, `msg`, `time`, `date`, `status`, `sender`) VALUES
(1, 1, 1, 'Hello', '09:00:00', '2017-05-06', 'unread', 'client'),
(2, 1, 2, 'Ayo', '05:00:00', '2017-05-07', 'unread', 'client'),
(3, 1, 3, 'Aber', '06:00:00', '2017-05-07', 'unread', 'client'),
(4, 1, 2, 'Uy', '07:00:00', '2017-05-07', 'unread', 'client'),
(5, 2, 1, 'Hi', '08:00:00', '2017-05-07', 'unread', 'client'),
(6, 1, 2, 'Checking', '09:00:00', '2017-05-14', 'unread', 'sp');
...
INSERT INTO `rate` (`sp_id`, `service_id`, `rate`) VALUES
(1, 1, 200);
...
INSERT INTO `request` (`request_id`, `sp_id`, `client_id`, `status`, `date`, `time`, `noofdays`, `sched_id`) VALUES
(1, 1, 1, 'accepted', '2017-05-06', '13:00:00', 0, 1),
(2, 1, 1, 'accepted', '2017-05-05', '14:00:00', 0, 1),
(3, 1, 1, 'accepted', '2017-05-07', '15:00:00', 0, 1),
(6, 1, 1, 'accepted', '2017-05-12', '08:30:50', 0, 2),
(8, 1, 1, 'rejected', '2017-05-15', '06:00:00', 0, 2),
(9, 1, 1, 'rejected', '2017-05-16', '08:00:00', 0, 2),
(13, 1, 1, 'accepted', '2017-05-17', '13:00:00', 3, 2),
(14, 1, 1, 'accepted', '2017-05-17', '14:00:00', 3, 2),
(15, 1, 1, 'accepted', '2017-05-17', '15:00:00', 3, 2),
(16, 1, 1, 'accepted', '2017-05-17', '16:00:00', 3, 2),
(17, 1, 1, 'accepted', '2017-05-17', '17:00:00', 3, 2),
(19, 1, 1, 'accepted', '2017-05-17', '19:00:00', 3, 1),
(20, 1, 1, 'accepted', '2017-05-17', '20:00:00', 3, 1),
(21, 1, 1, 'accepted', '2017-05-17', '21:00:00', 3, 1),
(22, 1, 1, 'accepted', '2017-05-14', '22:00:00', 3, 1),
(23, 1, 1, 'pending', '2017-05-15', '12:00:00', 3, 1);
...
INSERT INTO `schedule` (`sched_id`, `sp_id`, `time`, `day`, `status`, `service_id`) VALUES
(1, 1, '11:00 pm-12:00 pm', 'Thursday', 'taken', 1),
(2, 1, '2:00 pm-3:00 pm', 'Monday', 'taken', 1);
...
INSERT INTO `sp` (`sp_id`, `reg_status`, `lastname`, `firstname`, `gender`, `username`, `password`, `email`, `contact`, `address`, `about`) VALUES
(1, 'reject', 'Dela Cruz', 'Juan', 'm', 'sp1', '1234', '1234@gmail.com', NULL, '#123 Magsaysay St., Baguio City', NULL),
(2, 'approve', 'Escobar', 'Pablo', 'm', 'sp2', '1234', '69@gmail.com', '09996669999', '#234 Magsaysay St., Baguio City', NULL),
(3, 'pending', 'testSP', 'testSP', 'm', 'testSP', '7032ee4e588d09a8eea5334751dd5deceeebfc73', 'testSP@mail.com', '1231241', 'testSP', NULL);
...
INSERT INTO `transaction` (`transaction_id`, `status`, `paid`, `amount`, `request_id`, `date`) VALUES
(1, 'ongoing', 'unpaid', 100, 2, '2017-05-13'),
(2, 'ongoing', 'unpaid', 2000, 6, '2017-05-13'),
(3, 'ongoing', 'unpaid', 400, 3, '2017-05-13'),
(5, 'ongoing', 'unpaid', 100, 1, '2017-05-14'),
(6, 'ongoing', 'unpaid', 600, 13, '2017-05-14'),
(7, 'ongoing', 'unpaid', 600, 14, '2017-05-14'),
(8, 'ongoing', 'unpaid', 600, 15, '2017-05-14'),
(9, 'ongoing', 'unpaid', 600, 16, '2017-05-14'),
(10, 'ongoing', 'unpaid', 600, 17, '2017-05-14'),
(11, 'ongoing', 'unpaid', 600, 19, '2017-05-14'),
(12, 'ongoing', 'unpaid', 600, 20, '2017-05-14'),
(13, 'ongoing', 'unpaid', 600, 21, '2017-05-14'),
(14, 'ongoing', 'unpaid', 600, 22, '2017-05-14');
...
--
ALTER TABLE `log`
  ADD CONSTRAINT `fk_sp_log` FOREIGN KEY (`sp_id`) REFERENCES `sp` (`sp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
