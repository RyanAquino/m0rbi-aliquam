                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="addcategory.php">Categories</a></li>
        ...
        <div class="container">
            ...
            $clientquery = mysqli_query($connect, $query);
                                        ...
                                        <tr>
                                            ...
                                            <td><form method="POST">
                                            <button type="submit" class="btn btn-danger" name="delete"  value=<?php echo $row[0]; ?>>Delete</button>
                                             ...
                                             if(isset($_POST['delete'])){
                                                     ...
                                                     $deleteCat = "DELETE category from category where category = '$_POST[delete]'";
                                                     $deleteQ = mysqli_query($connect,$deleteCat) or die ('Cannot delete category!');
