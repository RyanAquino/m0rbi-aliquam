...
INSERT INTO `category` VALUES ('Academics',NULL),('Computers',NULL),('Cooking',NULL),('music',''),('Sports',NULL);
...
INSERT INTO `client` VALUES (1,'Makiling','Maria','123 Jupiter, Solar System','f','1997-12-31','client1','1234','mama@gmail.com','out',NULL),(2,'Juan','Pedro','123 Hello,from otherside','m','1998-10-31','juan','1234','juan@gmail.com','out',NULL);
...
INSERT INTO `message` VALUES (1,1,1,'Hello','09:00:00','2017-05-06','unread');
...
INSERT INTO `rate` VALUES (1,1,200),(1,2,200),(1,3,299),(1,9,900),(2,1,900),(2,2,900),(3,1,900);
...
INSERT INTO `request` VALUES (1,1,1,'pending','2017-05-06','13:00:00',1),(2,1,1,'accepted','2017-05-05','14:00:00',1),(3,1,1,'pending','2017-05-07','15:00:00',1);
...
INSERT INTO `service` VALUES (1,'violin','music'),(2,'guitar','music'),(3,'drums','music'),(4,'basketball','sports'),(5,'Soccer','sports'),(6,'Math','Academics'),(7,'Cakes','Cooking'),(8,'Dessert','Cooking'),(9,'Chocolate','Cooking');
...
INSERT INTO `sp` VALUES (1,'approve','Dela Cruz','Juan','m','sp1','1234','1234@gmail.com',NULL,'#123 Magsaysay St., Baguio City','logout'),(2,'approve','Dela Cross','Two','f','sp2','1234','two@gmail.com',NULL,'#23 lower nice Baguio City','logout'),(3,'approve','Maniti','Aldrienne','m','sp3','1234','aj@gmail.com',NULL,'#69 lower Dagsian Baguio City','logout');
...
-- Dump completed on 2017-05-14 18:27:06
