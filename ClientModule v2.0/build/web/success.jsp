    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase">Request has been sent</h3>
                <p class="text-muted m-t-30 m-b-30">Continue...</p>
                <a href="HomePage" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
            <footer class="footer text-center">2017 © MansanasTutorials</footer>
        </div>
    </section>
    <!-- jQuery -->
