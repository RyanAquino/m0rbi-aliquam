                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="Academics.jsp">Academics</a></h3>
                    ...
                    <div class="col-lg-4 col-sm-4 col-xs-4">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="Music.jsp">Music</a></h3>
                            <ul class="list-inline two-part">
                                <li>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="Arts.jsp">Performing Arts</a></h3>
                            <ul class="list-inline two-part">
                                <li>
