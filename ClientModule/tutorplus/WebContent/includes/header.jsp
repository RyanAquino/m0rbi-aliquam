        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="profile.html" class="waves-effect"><i class="fa fa-bell fa-fw" aria-hidden="true"></i>Notifications</a>
                    </li>
                    <li>
                        <a href="profile.html" class="waves-effect"><i class="fa fa-money fa-fw" aria-hidden="true"></i>Transactions</a>
                    </li>
                    <li>
                        <a href="calendar.html" class="waves-effect"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i>Calendar</a>
                    </li>
                </ul>
            </div>
