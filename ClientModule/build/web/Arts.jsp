<%-- 
    Document   : arts
    Created on : 05 13, 17, 3:04:38 AM
    Author     : Mai Radie
--%>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="academics.html">Academics</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <a href="" class="waves-effect"></a>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success">60</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-4 col-xs-4">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="music.html">Music</a></h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id=""><a href="" class="waves-effect"></a>
                                    </div>
                                </li>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="arts.html">Performing Arts</a></h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id=""><a href="" class="waves-effect"></a></div>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-info"></i> <span class="counter text-info">11</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-xs-12">
                    </div>
